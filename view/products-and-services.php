                ...
                <div class="container py-5">
                    <div class="row align-items-center mb-5">
                        <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                            ...
                            RMS Solutions provides the following services to its customers:
                            <ol>
                                <li>Services and monitoring</li>
                                <li>Remote Solutions</li>
                                <li>IT Services</li>
                                <li>Consultancy</li>
                                <li>Customized Solutions</li>
                                <li>Energy Monitoring</li>
                                <li>Generator Monitoring and Control</li>
                                <li>PCB Testing</li>
                            </ol>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
                            <h2 class="font-weight-light">SERVICE</h2>
                            <p class="font-italic text-muted mb-4">
                            Current Products of RMS Solutions:
                            <ol>
                                <li>Solar Monitoring </li>
                                <li>Solar Tracking System</li>
                                <li>Industrial Automation & Monitoring System</li>
                                <li>Tube well Monitoring System</li>
                            </ol>
                        </div>
                    </div>
                </div>
