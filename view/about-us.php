...
<body class="custom-font">
    ...
    <section class="pt-5">
        <div class="container pt-5">
            <div class="bg-light">
                <div class="container py-5">
                    <div class="row h-100 align-items-center py-5">
                        <div class="col-lg-6">
                            <h1 class="display-4">RMS Solutions</h1>
                            <p class="lead text-muted mb-0">We, the RMS Solutions are a remote monitoring systems service provider. With more than 10 years’ of experience in remote monitoring systems, RMS solutions provides high-end products and services that can cover a range of different domains. We specialize in remote monitoring system design and implementation, IT services, PCB design, and customized solutions. We take every project with utmost respect and professionalism, and never compromise on quality. We, at RMS solutions, believe that by maintaining high quality we gain the trust of our costumer and as a result a lifelong friend. These principles are the driving force behind our success at RMS Solutions. </p>
                        </div>
                ...
                <div class="container py-5">
                    <div class="row align-items-center mb-5">
                        <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                            ...
                            <p class="font-italic text-muted mb-4">The vision of RMS solutions is to land itself in one of the state-of-the-art remote monitoring systems solution providers in the world by following in the principles of honesty and professionalism with no compromise on quality. </p><a href="#"
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
                            ...
                            <p class="font-italic text-muted mb-4">The mission of RMS solutions is to provide its costumer with solutions that fulfil the requirements of the task and the desires of the customer with precision and clarity.</p><a href="#"
                                class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-light py-5" style="display: none;">
                <div class="container py-5">
                    <div class="row mb-4">
                        <div class="col-lg-5">
                            <h2 class="display-4 font-weight-light">Our team</h2>
                            <p class="font-italic text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-xl-3 col-sm-6 mb-5">
                            <div class="bg-white rounded shadow-sm py-5 px-4"><img
                                ...
                                <h5 class="mb-0">Manuella Nevoresky</h5><span
